        ...
        <motion.div className="max-w-5xl mx-auto text-center relative z-10 pointer-events-auto" style={{ y: textY, opacity: textOpacity }}>
          <motion.div {...fadeInUp}>
            <span className="px-4 py-1.5 rounded-full bg-rose-100/80 dark:bg-rose-950/50 backdrop-blur-md text-rose-800 dark:text-rose-400 text-sm font-semibold mb-6 inline-block border border-rose-200 dark:border-rose-900 shadow-sm">
              UI/UX Design | Python Development | Automation & Analytics
            </span>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} className="text-center lg:text-left">
            ...
            <div className="space-y-6 text-gray-600 dark:text-gray-400 text-base sm:text-lg leading-relaxed text-justify">
              ...
              As an <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Information Technology</strong> student from the <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Polytechnic University of the Philippines (PUP) Sta. Mesa</strong>, I am driven by a passion for building automated systems that are as intelligent as they are elegant.
              </motion.p>
              <motion.p variants={staggerItem} className="group transition-all duration-300" style={{ textJustify: 'inter-word', letterSpacing: '0.01em' }}>
                  My background is built on a foundation of academic excellence, maintaining a <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">President's Lister</strong> standing with a strong emphasis on problem-solving. Beyond the classroom, I’ve completed a <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">500-hour training requirement</strong> at <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Adventus IT Services</strong>, refining my skills in <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">User Acceptance Testing (UAT)</strong>. Additionally, I evolved my part-time <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Data Management Assistant</strong> role by integrating <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Intelligent Automation</strong>. I engineered <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Workflow Orchestration</strong> using <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Power Automate</strong> and <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">AI Builder</strong> to replace manual data entry with <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Intelligent Document Processing (IDP)</strong>, ensuring 100% accuracy while visualizing complex metrics through interactive <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Power BI</strong> dashboards.
              </motion.p>
              <motion.p variants={staggerItem} className="group transition-all duration-300" style={{ textJustify: 'inter-word', letterSpacing: '0.01em' }}>
                  Bridging my core expertise in <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">UI/UX Design</strong> and <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">Python (Flask)</strong> development with modern enterprise tools, I create holistic solutions. Whether architecting an NFC-based system like <strong className="text-black dark:text-white inline-block group-hover:scale-105 group-hover:text-rose-800 dark:group-hover:text-rose-500 transition-all duration-300">GLAM-ID</strong> or deploying data-driven cloud flows, my goal remains delivering professional-grade excellence with every project.
              </motion.p>
            </div>
